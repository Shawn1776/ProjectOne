...
class My_Test {
	...
	public static void main(String[] args) {
		...
		Table4 movie = new Table4("movie",
				"title year length genre studioName producerNo",
				"String Integer Integer String String Integer", "title year");

		Table4 cinema = new Table4("cinema",
				"title year length genre studioName producerNo",
				"String Integer Integer String String Integer", "title year");
		
		Table4 cinema2 = new Table4("cinema2",
				"title year length genre studioName producerNo",
				"String Integer Integer String String Integer", "title year");

		Table4 movieStar = new Table4("movieStar",
				"name address gender birthdate",
				"String String Character String", "name");

		Table4 starsIn = new Table4("starsIn", "movieTitle movieYear starName",
				"String Integer String", "movieTitle movieYear starName");

		Table4 movieExec = new Table4("movieExec", "certNo name address fee",
				"Integer String String Float", "certNo");

		Table4 studio = new Table4("studio", "name address presNo",
		...
		out.println();
		Table4 t_project = movie.project("title year");
		t_project.print();
		...
		out.println();
		Table4 t_select = movie.select(t -> t[movie.col("title")]
		...
		out.println();
		Table4 t_iselect = movieStar.select(new KeyType("Harrison_Ford"));
		t_iselect.print();
		...
		out.println();
		Table4 t_union = movie.union(cinema);
		t_union.print();
		...
		out.println();
		Table4 t_minus = movie.minus(cinema);
		t_minus.print();
		...
		out.println();
		Table4 t_join = movie.join("studioName", "name", studio);
		t_join.print();

		out.println();
		Table4 t_join2 = movie.join("title year", "title year", cinema);
		t_join2.print();
